...
struct Assets
{
  ...
  struct SkeletonAnimations
  {
    ...
    const AssetName<Rendering::SkeletonAnimationData> Chicken_0_picotear = AssetName<Rendering::SkeletonAnimationData>(Hash(4146678407));
    ...
    const AssetName<Rendering::SkeletonAnimationData> Chicken_1_picotear = AssetName<Rendering::SkeletonAnimationData>(Hash(4146980487));
    ...
    const AssetName<Rendering::SkeletonAnimationData> Chicken_2_picotear = AssetName<Rendering::SkeletonAnimationData>(Hash(4148241031));
