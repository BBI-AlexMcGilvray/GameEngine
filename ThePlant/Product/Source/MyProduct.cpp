...
namespace Product
{
    void MyProduct::initialize()
    {
        ...
        Testing::SpawnStaticCollider(Core::Geometric::Box(), Math::Lerp(modifiedLeft, modifiedRight, 0.2f));
        Testing::SpawnStaticCollider(Core::Geometric::Line3D(Core::Math::Float3(1.0f, 0.0f, 0.0f), false), Math::Lerp(modifiedLeft, modifiedRight, 0.4f));
        Testing::SpawnStaticCollider(Core::Geometric::Line3D(Core::Math::Float3(1.0f, 0.0f, 0.0f), false), Math::Lerp(_leftPos, _rightPos, 0.50f) + Core::Math::Float3(0.0f, 0.0f, 0.2f), rotation2);
        Testing::SpawnStaticCollider(Core::Geometric::Spot3D(), Math::Lerp(modifiedLeft, modifiedRight, 0.6f)); // works with: spot3D, sphere
        Testing::SpawnStaticCollider(Core::Geometric::Sphere(), Math::Lerp(modifiedLeft, modifiedRight, 0.8f), Core::Math::FQuaternion(Core::Math::II()), 2.0f); // works with: sphere
