	...
	*/
	struct Assets
	{
		...
		struct SkeletonAnimations
		{
			...
			const AssetName<Rendering::SkeletonAnimationData> Chicken_0_picotear.005 = AssetName<Rendering::SkeletonAnimationData>(AsHash(4146678407));
			...
			const AssetName<Rendering::SkeletonAnimationData> Chicken_1_picotear.005 = AssetName<Rendering::SkeletonAnimationData>(AsHash(4146980487));
			...
			const AssetName<Rendering::SkeletonAnimationData> Chicken_2_picotear.005 = AssetName<Rendering::SkeletonAnimationData>(AsHash(4148241031));
