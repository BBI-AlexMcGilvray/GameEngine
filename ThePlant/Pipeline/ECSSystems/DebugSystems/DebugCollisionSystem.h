...
private:
    ...
    struct ScaleGetter
    {
        ...
        Core::Math::Float3 operator()(const Core::Geometric::Line2D& line) const { return line.infinite ? Core::Math::Float3(line.line, 0.0f) * Core::Math::Float3(RENDER_MAX) : Core::Math::Float3(line.line, 0.0f); }
        Core::Math::Float3 operator()(const Core::Geometric::Line3D& line) const { return line.infinite ? line.line * Core::Math::Float3(RENDER_MAX) : line.line; }
