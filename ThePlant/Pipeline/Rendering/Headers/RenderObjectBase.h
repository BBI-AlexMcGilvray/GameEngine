...
namespace Rendering {
  ...
  struct RenderObjectBase
  {
    ...
    RenderObjectBase(Core::Ptr<RenderManager> manager, Core::Ptr<Geometric::HierarchyTransform> renderTransform, Core::Math::Color color = Core::Math::Color(1.0f, 1.0f, 1.0f, 1.0f));
  ...
  protected:
    ...
    Core::Ptr<Geometric::HierarchyTransform> RenderTransform;
