...
namespace Geometric {
    // LINE
    float Distance(const ShapeOrientation<Line3D>& line, const ShapeOrientation<Point3D>& point);
    float Distance(const ShapeOrientation<Line3D>& line1, const ShapeOrientation<Line3D>& line2);

    // PLANE
    float Distance(const ShapeOrientation<Plane>& plane, const ShapeOrientation<Point3D>& point);
    ...
    // SPHERE
    float Distance(const ShapeOrientation<Sphere>& sphere, const ShapeOrientation<Point3D>& point);
    ...
    // BOX
    float Distance(const ShapeOrientation<Box>& box, const ShapeOrientation<Point3D>& point);
